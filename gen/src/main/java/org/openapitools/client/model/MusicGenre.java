 ...
 */
@JsonAdapter(MusicGenre.Adapter.class)
public enum MusicGenre {
  ...
  public static class Adapter extends TypeAdapter<MusicGenre> {
    @Override
    public void write(final JsonWriter jsonWriter, final MusicGenre enumeration) throws IOException {
    ...
    public MusicGenre read(final JsonReader jsonReader) throws IOException {
      ...
      return MusicGenre.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MusicGenre.fromValue(value);
  }
}
